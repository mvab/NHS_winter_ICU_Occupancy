...
```{r echo=F}
tiff("figs/icu_adult_bristol.tiff", height=13, width=13, units = "cm", res = 300) 
plot_circular_heatmap(df=dat_adult_bristol,  "Adult critical care")
dev.off()
```
...
```{r echo=F}
tiff("figs/icu_paediatric_bristol.tiff", height=13, width=13, units = "cm", res = 300) 
plot_circular_heatmap(df=dat_adult_bristol,  "Adult critical care")
dev.off()
```
...
```{r echo=F}
tiff("figs/icu_neonatal_bristol.tiff", height=13, width=13, units = "cm", res = 300) 
plot_circular_heatmap(df=dat_adult_bristol,  "Adult critical care")
dev.off()
```
